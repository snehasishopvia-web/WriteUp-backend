...
const FRONTEND_URL = process.env.STUDENT_FRONTEND_URL!;
...
export const sendStudentOnboardEmail = async (
  email: string,
  studentName: string,
  schoolName: string,
  schoolKey: string
  ...
  const studentPortalLink = `${FRONTEND_URL}/register-with-email/?email=${encodeURIComponent(
    email
  ...
  const msg: MailDataRequired = {
    ...
    templateId: process.env.SENDGRID_STUDENT_ONBOARD_TEMPLATE_ID!,
    dynamicTemplateData: {
